  ...
  <form action="register" method="post">
    <div class="flex justify-center items-center gap-4 bg-[#5A945B] p-5 rounded-b">
      <div class="flex flex-col items-center gap-6 ">
        ...
        <div>
          <input class="rounded pl-1" type="password" name="confirm_password" placeholder="confirm password">
        </div>
        <button class="border-2 border-white px-5 rounded text-white" type="submit">Register</button>
      </div>
    </div>
  </form>
